...
public class How_To_Compare_Tow_HashMap {
	...
	public static void main(String[] args) {
		...
		HashSet<Integer> combineKey = new HashSet<Integer>();
		...
		// in this case we are try to find the duplicate so we are using the Array List
		// Because Array List not Accept the duplicate
		...
		// duplicate are allowed using the HashMap method
		System.out.println(new HashSet<>(map5.values()).equals(new HashSet<>(map6.values()))); // true
		System.out.println(new HashSet<>(map5.values()).equals(new HashSet<>(map7.values()))); // false
